...
export default function PreviewSection() {
  return (
    <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 bg-[#7B85A8]">
          ...
          <div className="relative flex justify-center md:justify-end mt-8 md:mt-0">
            ...
            <div className="relative w-[280px] h-[460px] sm:w-[320px] sm:h-[525px] md:w-[350px] md:h-[575px] lg:w-[380px] lg:h-[620px]">
              ...
              <div className="absolute inset-0 bg-black rounded-[40px] sm:rounded-[44px] md:rounded-[48px] p-[2.5px] sm:p-[3px]">
                {/* Inner border layer */}
                <div className="w-full h-full bg-[#8A94B5] rounded-[37.5px] sm:rounded-[41px] md:rounded-[45px] p-[2px]">
                  {/* Phone screen */}
                  <div className="w-full h-full bg-[#8A94B5] rounded-[35.5px] sm:rounded-[39px] md:rounded-[43px] overflow-hidden">
